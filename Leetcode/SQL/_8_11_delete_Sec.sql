...
SELECT SCI_PLEDGOR_DTL.* FROM SCI_PLEDGOR_DTL, SCI_SEC_PLDGR_MAP, CMS_SECURITY, CMS_LIMIT_SECURITY_MAP, SCI_LSP_APPR_LMTS 
...
AND cms_security.CMS_COLLATERAL_ID IN (SELECT CMS_COLLATERAL_ID FROM CMS_SECURITY WHERE LOS_SECURITY_DTL_ID = 202207260022523353 ) ;

SELECT SCI_SEC_PLDGR_MAP.*
FROM SCI_PLEDGOR_DTL, SCI_SEC_PLDGR_MAP, CMS_SECURITY, CMS_LIMIT_SECURITY_MAP, SCI_LSP_APPR_LMTS 
WHERE SCI_PLEDGOR_DTL.CMS_PLEDGOR_DTL_ID = SCI_SEC_PLDGR_MAP.CMS_PLEDGOR_DTL_ID 
	AND SCI_SEC_PLDGR_MAP.CMS_COLLATERAL_ID = CMS_SECURITY.CMS_COLLATERAL_ID 
	AND cms_security.CMS_COLLATERAL_ID IN (SELECT CMS_COLLATERAL_ID FROM CMS_SECURITY WHERE LOS_SECURITY_DTL_ID = 202207260022523353 ) ;
