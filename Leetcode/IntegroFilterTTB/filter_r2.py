...
for filename in os.listdir(directory):
  ...
  for i in range(len(strings)):
    ...
    if CONTAIN_CHECK_STRING in strings[i]:
      ...
      if  MUST_NOT_CONTAIN not in shortenStringRes and shortenStringRes not in roundResult:
        roundResult.append(shortenStringRes)

  result_strings.extend(roundResult)

# Set the output file name
output_file_name = "D:/11.29.HH.moveLaptop/HHgithub/Pythonhead/Leetcode/IntegroFilterTTB/result_file5.csv"
header = ['Filter data']
