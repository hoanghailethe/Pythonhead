        ...
        USING   (SELECT   ce.entry_code AS code,
                  ...
                  ce.category_code NOT IN
                          (-- 1.base on special columns ;
                            ...
                            'BUSINESS_TYPE_2',
                            '56',
                            -- key is entry_code  , category_code , entry_name , ref_entry_code
                            'FAC_PRODUCT_MAP',
                           --2. special insert rule. COMMON_CODE_CATEGORY_ENTRY.REF_ENTRY_CODE map to code_value.display_order
                            'AA_TREASURY_TENOR',
                            'AA_PRODUCT_GROUP',
                            'AA_ISSUER_LIMIT_TENOR',
